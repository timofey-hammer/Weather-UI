...
//  Created by Timofey Hammer on 2023-04-19.
...
struct NavigationBar: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            .innerShadow(shape: RoundedRectangle(cornerRadius: 10), color: .black.opacity(0.25), lineWidth: 2,
                         offsetX: 0, offsetY: 2, blur: 2)
        }
